...
mon_def = 10
# this is the monster hitpoint value, used to calculate number of hit rolls
mon_hp = 100
...
def strike():
    ...
    # loop while monster health is remaining , the total attack is incase you get weird glitch
    
    while True and total_attack < 200:
