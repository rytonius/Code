...
def calculate_frequencies(file_contents):
    ...
    mydict = "".join((ch if ch not in punctuations else " ") for ch in file_contents).lower().split()
    mydict = [word for word in mydict if word not in uninteresting_words]
    ...
    cloud.generate_from_frequencies(freqwords)
