...
void print_function( struct generic_tag generic )
{
    ...
    switch( generic.type )
    {
        case    CHARACTER: printf("character: %c", generic.shared.c); break;
        case    INTEGER:   printf("Integer: %d", generic.shared.i); break;
        case    FLOAT:     printf("float: %f", generic.shared.f); break;
