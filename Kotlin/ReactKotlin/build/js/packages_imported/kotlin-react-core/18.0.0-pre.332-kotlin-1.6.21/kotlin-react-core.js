(function (root, factory) {
  ...
  var useRefCallback = defineInlineFunction('kotlin-react-core.react.useRefCallback_ar7qiy$', wrapFunction(function () {
  ...
  var useCallback = defineInlineFunction('kotlin-react-core.react.useCallback_3tr83r$', wrapFunction(function () {
    var rawUseCallback = _.$$importsForInline$$.react.useCallback;
    return function (dependencies, callback) {
      return rawUseCallback(callback, dependencies);
    };
  ...
  var useImperativeHandle = defineInlineFunction('kotlin-react-core.react.useImperativeHandle_g1uai9$', wrapFunction(function () {
  ...
  var useMemo = defineInlineFunction('kotlin-react-core.react.useMemo_58jryq$', wrapFunction(function () {
  ...
  package$react.useImperativeHandle_g1uai9$ = useImperativeHandle;
